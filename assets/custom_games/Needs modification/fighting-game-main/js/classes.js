...
class Fighter extends Sprite {
  ...
  update(ctx) {
    ...
    // Apply gravity and boundary checks
    ...
    if (this.position.y + this.height + this.velocity.y >= canvas.height - 96) {
      this.velocity.y = 0;
      this.position.y = canvas.height - this.height - 96; // Set to bottom boundary
    } else {
  ...
  attack() {
    ...
    if (now - this.lastAttackTime >= this.attackCooldown) {
      ...
      this.lastAttackTime = now; // Update the last attack time
    }
  }
