                    ...
                    <div class="card-body">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input class="form-control" name="min" type="number" value="{{ getAmount($game->min_limit) }}" step="any" placeholder="@lang('Minimum Invest Amount')" required>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input class="form-control" name="max" type="number" value="{{ getAmount($game->max_limit) }}" step="any" placeholder="@lang('Maximum Invest Amount')" required>
                                                        <span class="input-group-text">{{ gs('cur_text') }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card border--primary">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input class="form-control" name="probable" type="number" value="{{ getAmount($game->probable_win) }}" required>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input class="form-control" name="win" type="number" value="{{ getAmount($game->win) }}" step="any" required>
                                                        <span class="input-group-text">%</span>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card border--primary mt-3">
                                <h5 class="card-header bg--primary">@lang('Game App Short Description')</h5>
                                <div class="card-body">
                                    <div class="form-group">
                                        <textarea class="form-control border-radius-5" name="short_desc" rows="4">@php echo $game->short_desc @endphp</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
