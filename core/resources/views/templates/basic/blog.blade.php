                    ...
                    <div class="col-lg-4 col-md-6 mb-30 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.3s">
                        <div class="post-card">
                            ...
                            <div class="post-card__content">
                                <h3 class="post-card__title mt-2 mb-3"><a href="{{ route('blog.details', $blog->slug) }}">{{ __(@$blog->data_values->title) }}</a>
                                </h3>
                                <a class="cmn-btn btn-sm mt-3" href="{{ route('blog.details', $blog->slug) }}">@lang('Read More')</a>
                            </div>
                        </div>
                    </div>
                @endforeach
